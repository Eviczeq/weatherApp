...
const imgUrlBase ='https://www.metaweather.com/';
...
const UpcomingDaysForecastItem = ({weekday , temperature, imgUrl}) => (
    <li className={`${styles.weekday} d-flex flex-column justify-content-center align-items-center p-2`}>
        <img width={30} src={`${imgUrlBase}/static/img/weather/${imgUrl}.svg`} alt="weater icon" className="mb-2" />
        <span className="mb-2"> {weekday} </span>
        <span className="mb-2 font-weight-bold"> {temperature}&deg; </span>
    </li>
);
